...
export PATH="/home/levi/temp/kernel/my/11-kernel-crosscompiler/i386elfgcc/bin:$PATH"
...
# useful for exiting ranger to working directory
alias r='PYTHONOPTIMIZE=1 ranger --choosedir=$HOME/.rangerdir; LASTDIR=`cat $HOME/.rangerdir`; cd "$LASTDIR"'
alias py2='python2'
alias py3='python3'
alias yd='youtube-dl'
...
alias wsavemin='wget -p -k'
alias imview='feh -g 640x480 -d -S filename '
alias iv='iverilog'
alias hw='inxi'
alias ip='sudo ip'
alias sctl='sudo systemctl'
alias aa='startx'
alias gg='cd /media/data'
alias z='zathura'
