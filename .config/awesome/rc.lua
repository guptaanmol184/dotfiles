...
run_once({ "unclutter -root", "nm-applet", "compton", "conky" }) -- entries must be comma-separated
-- }}}
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "e", function () awful.spawn(gui_file_manager) end,
    ...
    awful.key({ altkey }, "Tab", function () os.execute("rofi -show window") end,
              {description = "window browser", group = "launcher"}),
